...
# 5. Create a low‑RAM environment LaunchAgent
Create an upgrade-proof LaunchAgent that sets Ollama environment variables before Homebrew starts the service.
...
Now you can download the model once and use it fully offline:
